		...
		<div class="row">
			<div class="col-12">
				<div class="p-4 text-center rounded-3" >
					<h1 class="text-white m-0">Menú</h1>
					<!-- Breadcrumb -->
					<div class="d-flex justify-content-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb breadcrumb-dots mb-0">
								<li class="breadcrumb-item "><a href="home"><span class="text-white m-0">Inicio</span></a></li>
								<li id="dot" class="breadcrumb-item active" aria-current="page"><span class="text-white m-0"> Menú</span></li>
							</ol>
						</nav>
					</div>
				</div>
...
<section class="pt-4">
	<div class="container">
		...
		<h2 class="text-xl-center text-center">Coctel de Bienvenida</h2>
		<br><br>
		...
		<h2 class="text-xl-center text-center mt-6">Cena de Clausra</h2>
		<br><br>
		<div class="row g-4 justify-content-center">
					...
					<div class="row g-0">
						...
						<div class="col-md-8 col-12">
							<div class="card-body">
								...
								<!-- Content -->
								<!-- <p class="text-truncate-1 mb-3">Pruebe nuestra variedad de Entrada.</p> -->
								<div id="card-movil" class="col-md-8 mt-md-3 d-sm-flex justify-content-sm-between align-items-center">
									<ul style="color: black; font-size: small;">
										<!-- <li class="li-numb">
											<p>
					...
					<div class="row g-0">
						...
						<div class="col-md-8 col-12">
							<div class="card-body">
								...
								<!-- Content -->
								<!-- <p class="text-truncate-2 mb-3">Pruebe nuestra gran variedad de postre.</p> -->
