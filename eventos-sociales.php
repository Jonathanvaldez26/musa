...
<!-- =======================
Page Banner START -->
<section class="py-5 position-relative overflow-hidden" style="background-color: #CF7CAA40;">
	<!-- SVG decoration -->
	...
	<div class="container position-relative">
		<div class="row g-4 align-items-center">
			<div class="col-md-6">
				<!-- Title -->
				<h2>Comida Verpertina</h2>
				<h6>Hora: 17:00 - 20:00</h6>
				<p>Descripción</p>
				<!-- Button -->
			...
			<div class="col-md-6 text-center">
				<!-- Image -->
				<img src="assets/images/element/olla-caliente.png" class="h-300px h-xl-400px" alt="">
			</div>
		</div>
	</div>
</section>
...
<!-- =======================
Page Banner START -->
<section class="py-5 position-relative overflow-hidden" style="background-color: #9CDDA7a0;">
	...
	<div class="container position-relative">
		<div class="row g-4 align-items-center">
			<div id="derecha" class="col-md-6">
				<!-- Image -->
				<img src="assets/images/element/tirolesa.png" class="h-300px h-xl-400px" alt="">
			</div>
